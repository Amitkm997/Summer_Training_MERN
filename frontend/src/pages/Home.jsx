        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          <div className='flex justify-center gap-4'>
            <Link to='/registration'><button
              type="submit"
              disabled={loading}
              className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700n"
            >
              {loading ? "Registering..." : "Register Student"}
            </button></Link>
            <button className='bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700' onClick={()=>navigate('/companies')}>View Companies</button>
          </div>
        </div>
      </section>
